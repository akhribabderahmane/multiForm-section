...
const SideBar:React.FC<SideBarProps> = ({selectedStep,setSelectedStep}) => {
  return (
    <div
      className="background__desktop__image h-full  w-[30%] rounded-xl py-12 px-10 flex flex-col gap-y-4"
      style={{
        backgroundImage: `url("data:image/svg+xml,${encodeURIComponent(
          backgroundDesktopSvg
        )}")`,
      }}
    >
      <SideItem
