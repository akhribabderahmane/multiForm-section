...
const ThankYouPage = () => {
  return (
    <div className="h-full flex flex-col w-full justify-center items-center pb-8">
      <div className=" mb-8">{thankYouIcon}</div>
      <div>
        <p className=" font-bold text-marine-blue text-4xl mb-4">Thank You!</p>
      </div>
